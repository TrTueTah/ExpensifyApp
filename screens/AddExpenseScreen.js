...
export default function AddExpenseScreen(props) {
  ...
  console.log("id in AddExpense: ", id)
      ...
      <View className='flex justify-between h-full mx-4'>
        <View>
          <View  className = 'relative mt-5'>
            ...
            <Text className={`${colors.heading} text-xl font-bold text-center z-0`}>Add Expense</Text>
          </View>
          ...
          <View className='space-y-2 mx-2'>
            ...
            <TextInput value={title} onChangeText={value => setTitle(value)} className = 'p-4 bg-white rounded-full mb-3 h-11'/>
            <Text className = {`${colors.heading} text-lg font-bold`}>How Much?</Text>
            <TextInput value={amount} onChangeText={value => setAmount(value)} className = 'p-4 bg-white rounded-full mb-3 h-11'/>
          </View>
