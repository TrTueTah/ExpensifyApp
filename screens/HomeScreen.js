  ...
  return (
    <ScreenWrapper className='flex-1'>
        <View className='flex-row justify-between items-center p-4'>
            ...
            <TouchableOpacity onPress = {handleLogout} className='p-2 px-3 bg-whith border border-gray-200 rounded-full'>
        ...
        <View className='px-4 space-y-4'>
            <View className='flex-row justify-between items-center'>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('AddTrip')} className='p-2 px-3 bg-whith border border-gray-200 rounded-full'>
